...
export default function ReportCard({ progress }) {
  return (
    <Card className="rounded-2xl shadow-lg bg-gradient-to-br from-green-100 to-white hover:shadow-xl transition">
      <CardContent className="p-5 space-y-5">
        <h2 className="text-xl font-bold text-teal-700">📈 Progress Report</h2>
